...
class Image_(Frame):
    ...
    def Copy(self):
        original = cv2.imread('smechariki.jpg', cv2.IMREAD_COLOR)
        self.img1=original
    ...
    def Black_White(img):
        thresh = 155
        img = cv2.imread('smechariki.jpg', cv2.IMREAD_GRAYSCALE)
        # threshold the image
    ...
    def Contrast(self, factor):
        ...
        image = Image.open("smechariki.jpg")
        ...
        image2 = cv2.imread("smechariki.jpg")
...
def menu_ch():
    ...
    btn = Button(root, text="Вывод синего канала", padx=5, pady=5, command = im.Channel_S, bg='#eec6ea')  
    btn.pack(anchor="center", padx=20, pady=20)
    btn = Button(root, text="Вывод красного канала", padx=5, pady=5, command = im.Channel_K, bg='#eec6ea')  
    btn.pack(anchor="center", padx=20, pady=20)
    btn = Button(root, text="Вывод зеленого канала", padx=5, pady=5, command = im.Channel_Z, bg='#eec6ea')  
    btn.pack(anchor="center", padx=20, pady=20)
...
def Menu():
    ...
    btn3 = Button(window, text="Размытие", padx=5, pady=5, command = clicked2, bg='#eec6ea')  
    btn3.pack(anchor="center", padx=20, pady=10)

    btn5 = Button(window, text="Вывод канала", padx=5, pady=5, command = menu_ch, bg='#eec6ea')  
    btn5.pack(anchor="center", padx=20, pady=10)

    btn6 = Button(window, text="Изменение яркости и контраста", padx=5, pady=5, command =menu_bc , bg='#eec6ea')  
    btn6.pack(anchor="center", padx=20, pady=10)

    btn10 = Button(window, text="Логические операции", padx=5, pady=5, command =menu_log , bg='#eec6ea')  
    btn10.pack(anchor="center", padx=20, pady=10)

    btn7 = Button(window, text="Cartoon filter", padx=5, pady=5, command = img.Settings, bg='#eec6ea')  
    btn7.pack(anchor="center", padx=20, pady=10)

    btn8 = Button(window, text="Оконный фильтр", padx=5, pady=5, command =img.Mat , bg='#eec6ea')  
    btn8.pack(anchor="center", padx=20, pady=10)

    btn9 = Button(window, text="Акварельный фильтр", padx=5, pady=5, command =img.Aqua , bg='#eec6ea')  
    btn9.pack(anchor="center", padx=20, pady=10)

    btn4 = Button(window, text="Выход", padx=5, pady=5, command = clicked4, bg='#eec6ea')  
